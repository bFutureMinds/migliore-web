    ...
    return {
        ...
        execute: function() {
            AlertHandler = (function (_super) {
                ...
                function AlertHandler(notificationService) {
                    _super.call(this, notificationService);
                    this.notificationService = notificationService;
                }
                AlertHandler.prototype.handleNotification = function (notification) {
                    if (notification.type == notification_type_1.NotificationType.ALERT) {
                        toastr.info(notification.description);
                    }
                };
                AlertHandler = __decorate([
                    core_1.Component({
            ...
            exports_1("AlertHandler", AlertHandler);
        }
    }
});
//# sourceMappingURL=alertHandler.component.js.map